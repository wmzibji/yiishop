...
<body>
	...
	<div class="list w1210 bc mt10">
		...
		<div class="breadcrumb">
			<h2>当前位置：<a href="">首页</a> > <a href=""><?=$model1s['name']?></a></h2>
		</div>
		<!-- 面包屑导航 end -->
		...
		<div class="list_left fl mt10">
			...
			<div class="catlist">
				...
				<div class="catlist_wrap">
					<div class="child">
                        <?php foreach($model1s->children as $child1):?>
						<h3 class="on"><b></b><?=$child1->name?></h3>
                        <?php foreach($child1->children as $child2): ?>
						<ul>
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="goodslist mt10">
				<ul><?php foreach($models as $model):?>
					<li>
						<dl>
							<dt><a href="<?=Yii::getAlias('@web')?>/member/goods?id=<?=$model['id']?>"><img src="<?=$model['logo']?>" alt="" /></a></dt>
							<dd><a href="<?=Yii::getAlias('@web')?>/member/goods?id=<?=$model['id']?>"><?=$model['name']?></a></dt>
							<dd><strong><?=$model['shop_price']?></strong></dt>
							<dd><a href="<?=Yii::getAlias('@web')?>/member/goods?id=<?=$model['id']?>"><em>已有<?=$model['view_times']?>人评价</em></a></dt>
						</dl>
					</li>
                    <?php endforeach;?>
				</ul>
